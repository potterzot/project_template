...
[![Last-changedate](https://img.shields.io/badge/last%20change-`r gsub('-', '--', Sys.Date())`-brightgreen.svg)](https://github.com/potterzot/project_template/commits/master) 
...
Text: [CC0 1.0](https://creativecommons.org/publicdomain/zero/1.0/) except where prohibited by copyright
Code: [MIT License](https://opensource.org/licenses/MIT), `r format(Sys.time(), "%Y")`, Nicholas A Potter
